...
// Import Images
import main_image from "../../assets/images/for_pages/project_5.png";

const Project_Logistics = () => {
        ...
        >
          <div className="card rounded-2xl shadow-2xl overflow-hidden bg-white">
            <motion.img 
              ...
              width="100%" 
              height="350" 
              alt="MMSH Logistics Project Cargo"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1 }}
            />
            <div className="card-body bg-gray-100 p-8 rounded-b-2xl">
              ...
              >
                {t("project_logistics_description")}
              </motion.p>
...
export default Project_Logistics;
