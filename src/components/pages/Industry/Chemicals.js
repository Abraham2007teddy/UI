...
// Import Images
import main_image from '../../../assets/images/Industry/chemicals.png';

import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/Industry/global_chemical.png';
import second_news_image from '../../../assets/images/Industry/monitoring.png';
import third_news_image from '../../../assets/images/Industry/logist.png';
import fourth_news_image from '../../../assets/images/Industry/nature_chemical.png';

import first_projects_image from '../../../assets/images/Industry/europe_chemical.png';
import second_projects_image from '../../../assets/images/Industry/ai.png';
...
// Import Expert image
import expert from '../../../assets/images/experts/expert_7.png';
// Import Expert image
...
const Chemicals = () => {
  ...
  // Data
  const projects = [
    { title: t('projects_6.items.0.title'), imgSrc: first_news_image },
    { title: t('projects_6.items.1.title'), imgSrc: second_news_image },
    { title: t('projects_6.items.2.title'), imgSrc: third_news_image },
    { title: t('projects_6.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects_6.title'),
    projects: [
      { title: t('completed_projects_6.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects_6.items.1.title'), imgSrc: second_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_6')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro_6.main_text_6')}</h3>
              
              <div className="text-gray-900 font-large leading-relaxed tracking-wide space-y-5 mt-5">
                <p>{t('intro_6.text_1')}</p>
              </div>
      ...
      <Sidebar_products name="Oyatillo" 
                image={expert}/>
    </motion.div>
  );
};
