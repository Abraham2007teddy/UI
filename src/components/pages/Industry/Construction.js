...
// Import Images
import main_image from '../../../assets/images/Industry/construction.png';

import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/Industry/big_cargo.png';
import second_news_image from '../../../assets/images/Industry/ai_construction.png';
import third_news_image from '../../../assets/images/Industry/logistics_const.png';
import fourth_news_image from '../../../assets/images/Industry/sustainable_const.png';

import first_projects_image from '../../../assets/images/Industry/infrastructure.png';
import second_projects_image from '../../../assets/images/Industry/locate.png';
...
// Import Expert image
import expert from '../../../assets/images/experts/expert_13.png';
// Import Expert image
...
const Construction = () => {
  ...
  // Data
  const projects = [
    { title: t('projects_14.items.0.title'), imgSrc: first_news_image },
    { title: t('projects_14.items.1.title'), imgSrc: second_news_image },
    { title: t('projects_14.items.2.title'), imgSrc: third_news_image },
    { title: t('projects_14.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects_14.title'),
    projects: [
      { title: t('completed_projects_14.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects_14.items.1.title'), imgSrc: second_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_14')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro_14.main_text_14')}</h3>
              
              <div className="text-gray-900 font-large leading-relaxed tracking-wide space-y-5 mt-5">
                <p>{t('intro_14.text_1')}</p>
              </div>
      ...
      <Sidebar_products name="Ibrohimjon" 
                      image={expert}/>
    </motion.div>
  );
};
