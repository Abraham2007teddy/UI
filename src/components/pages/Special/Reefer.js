...
// Import Images
import main_image from '../../../assets/images/Special/reefer.png';

import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/Special/reefer_trucks.png';
import second_news_image from '../../../assets/images/Special/reefer_ai.png';
import third_news_image from '../../../assets/images/Special/reefer_logis.png';
import fourth_news_image from '../../../assets/images/Special/reefer_sustainable.png';

import first_projects_image from '../../../assets/images/Special/reefer_globe.png';
import second_projects_image from '../../../assets/images/Special/reefer_digital.png';
...
// Import Expert image
import expert from '../../../assets/images/experts/expert_11.png';
// Import Expert image
const Reefer = () => {
  ...
  // Data
  const projects = [
    { title: t('projects_20.items.0.title'), imgSrc: first_news_image },
    { title: t('projects_20.items.1.title'), imgSrc: second_news_image },
    { title: t('projects_20.items.2.title'), imgSrc: third_news_image },
    { title: t('projects_20.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects_20.title'),
    projects: [
      { title: t('completed_projects_20.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects_20.items.1.title'), imgSrc: second_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_20')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro_20.main_text_20')}</h3>
              
              <div className="text-gray-900 font-large leading-relaxed tracking-wide space-y-5 mt-5">
                <p>{t('intro_20.text_1')}</p>
              </div>
      ...
      <Sidebar_products name="Abbosbek" 
                        image={expert}/>
    </motion.div>
  );
};
