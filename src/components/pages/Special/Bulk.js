...
// Import Images
import main_image from '../../../assets/images/Special/bulk_3.png';
import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/Special/bulk_2.png';
import second_news_image from '../../../assets/images/Special/ai_bulk.jpg';
import third_news_image from '../../../assets/images/Special/bulk_logistics.png';
import fourth_news_image from '../../../assets/images/Special/bulk_multi.png';

import first_projects_image from '../../../assets/images/Special/bulk.png';
import second_projects_image from '../../../assets/images/Special/global_bulk.png';
...
// Import Expert image
import expert from '../../../assets/images/experts/expert_5.png';
// Import Expert image
const Bulk = () => {
  ...
  // Data
  const projects = [
    { title: t('projects_15.items.0.title'), imgSrc: first_news_image },
    { title: t('projects_15.items.1.title'), imgSrc: second_news_image },
    { title: t('projects_15.items.2.title'), imgSrc: third_news_image },
    { title: t('projects_15.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects_15.title'),
    projects: [
      { title: t('completed_projects_15.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects_15.items.1.title'), imgSrc: second_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      ...
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_15')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro_15.main_text_15')}</h3>
              
              <div className="text-gray-900 font-large leading-relaxed tracking-wide space-y-5 mt-5">
                <p>{t('intro_15.text_1')}</p>
              </div>
      ...
      {/* Sidebar - Including the Contact Form */}
      <div className="sidebar-container ml-4">
        <Sidebar_products name="Ulug'bek" 
                                image={expert}/>
      </div>
    </motion.div>
  );
