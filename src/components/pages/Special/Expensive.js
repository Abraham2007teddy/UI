...
// Import Images
import main_image from '../../../assets/images/Special/jewelry.png';

import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/Special/expensive_logistics.png';
import second_news_image from '../../../assets/images/Special/ai_expensive.png';
import third_news_image from '../../../assets/images/Special/expensive_biometric.png';
import fourth_news_image from '../../../assets/images/Special/expensive_logis.png';

import first_projects_image from '../../../assets/images/Special/expensive_globe.png';
import second_projects_image from '../../../assets/images/Special/expensive_truck_2.png';
...
// Import Expert image
import expert from '../../../assets/images/experts/expert_15.png';
// Import Expert image
const Expensive = () => {
  ...
  // Data
  const projects = [
    { title: t('projects_16.items.0.title'), imgSrc: first_news_image },
    { title: t('projects_16.items.1.title'), imgSrc: second_news_image },
    { title: t('projects_16.items.2.title'), imgSrc: third_news_image },
    { title: t('projects_16.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects_16.title'),
    projects: [
      { title: t('completed_projects_16.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects_16.items.1.title'), imgSrc: second_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_16')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro_16.main_text_16')}</h3>
              
              <div className="text-gray-900 font-large leading-relaxed tracking-wide space-y-5 mt-5">
                <p>{t('intro_16.text_1')}</p>
              </div>
