...
// Import Images
import main_image from '../../../assets/images/Drivers/restriction.png';
import euro_visa from '../../../assets/images/Drivers/euro_visa.png';
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_23')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-center mt-2">{t('intro_23.main_text_23')}</h3>
            <p className='m-3'>{t('intro_23.text_1')}</p>
