...
// Import Images
import main_image from '../../../assets/images/Transport/trains.png';

import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/Transport/digital.png';
import second_news_image from '../../../assets/images/Transport/europe.png';
import third_news_image from '../../../assets/images/Transport/Japan_trains.png';
import fourth_news_image from '../../../assets/images/Transport/salary.png';

import first_projects_image from '../../../assets/images/Transport/ohio.png';
import second_projects_image from '../../../assets/images/Transport/time.png';
import third_projects_image from '../../../assets/images/Transport/China.png';
import fourth_projects_image from '../../../assets/images/Transport/app.png';
...
const Trains = () => {
  ...
  // Data
  const projects = [
    { title: t('projects_2.items.0.title'), imgSrc: first_news_image },
    { title: t('projects_2.items.1.title'), imgSrc: second_news_image },
    { title: t('projects_2.items.2.title'), imgSrc: third_news_image },
    { title: t('projects_2.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects_2.title'),
    projects: [
      { title: t('completed_projects_2.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects_2.items.1.title'), imgSrc: second_projects_image },
      { title: t('completed_projects_2.items.2.title'), imgSrc: third_projects_image },
      { title: t('completed_projects_2.items.3.title'), imgSrc: fourth_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title_2')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro_2.main_text_2')}</h3>
              
              <div className="text-gray-900 font-large leading-relaxed tracking-wide space-y-5 mt-5">
                <p>{t('intro_2.text_1')}</p>
              </div>
