...
// Import Images
import main_image from '../../../assets/images/Transport/truck_show.png';

import abstract_icon from '../../../assets/images/MMSH/certificates/abstract.png';

import first_news_image from '../../../assets/images/for_pages/driver.png';
import second_news_image from '../../../assets/images/for_pages/IT.png';
import third_news_image from '../../../assets/images/for_pages/office.png';
import fourth_news_image from '../../../assets/images/for_pages/turkey.png';

import first_projects_image from '../../../assets/images/Transport/new_port.png';
import second_projects_image from '../../../assets/images/Transport/win.png';
import third_projects_image from '../../../assets/images/Transport/new_york.png';
...
const Trucks = () => {
  ...
  // Data
  const projects = [
    { title: t('projects.items.0.title'), imgSrc: first_news_image },
    { title: t('projects.items.1.title'), imgSrc: second_news_image },
    { title: t('projects.items.2.title'), imgSrc: third_news_image },
    { title: t('projects.items.3.title'), imgSrc: fourth_news_image },
  ];

  const completedProjectsData = {
    title: t('completed_projects.title'),
    projects: [
      { title: t('completed_projects.items.0.title'), imgSrc: first_projects_image },
      { title: t('completed_projects.items.1.title'), imgSrc: second_projects_image },
      { title: t('completed_projects.items.2.title'), imgSrc: third_projects_image },
    ]
  };
  ...
  return (
    ...
    >
      <div className="main-content flex-grow-1">
        <motion.h3 className="text-2xl font-bold text-center mb-6">{t('title')}</motion.h3>
        ...
        >
          <div className="card rounded-xl shadow-xl overflow-hidden">
            ...
            <div className="card-body bg-gray-100 p-6">
              <h3 className="text-xl font-bold text-center">{t('intro.main_text')}</h3>
